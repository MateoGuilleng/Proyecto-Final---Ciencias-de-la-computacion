...
/**
 * Representa un cliente de la empresa AutoRescate 24/7. El tipo de cliente
 * (ORDINARIO o PRIORITARIO) aporta puntos al cálculo automático de prioridad de
 * sus solicitudes.
 *
...
public class Cliente {
    ...
    /**
     * Clasificación del cliente según su importancia operativa. Aporta puntos
     * al sistema de prioridad automática de solicitudes.
     */
