...
public class Kit {
    ...
    /**
     * Decisión de revisión asignada al regresar del servicio. Determina qué
     * hará el operario automáticamente.
     */
     ...
     */
    public void setDecision(DecisionRevision decision) {
        this.decision = decision;
    }

    /**
     * Asigna aleatoriamente una decisión de revisión al kit cuando regresa de
     * un servicio. Probabilidades: 50% NADA, 30% REPARAR, 20% REPONER.
     */
    public void asignarDecisionAleatoria() {
        int r = RANDOM.nextInt(10);
        if (r < 5) {
            this.decision = DecisionRevision.NADA;
        } else if (r < 8) {
            this.decision = DecisionRevision.REPARAR;
        } else {
            this.decision = DecisionRevision.REPONER;
        }
    }
