 ...
 * La prioridad se calcula automáticamente sumando los puntos del tipo de cliente,
 * la zona del incidente y el tipo de servicio solicitado.
 * Si la suma es mayor o igual a 3, la solicitud es CRITICA; si no, ORDINARIA.
 *
...
public class SolicitudServicio {
    ...
    /**
     * Construye una nueva solicitud con estado PENDIENTE.
     * La prioridad se calcula automáticamente con la fórmula:
    ...
    public Tecnico.TipoServicio getTipoServicio() { return tipoServicio; }
