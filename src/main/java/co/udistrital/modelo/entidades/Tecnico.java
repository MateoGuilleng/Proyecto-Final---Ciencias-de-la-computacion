 ...
 * Cada técnico tiene una especialidad que determina los servicios que puede atender
 * y un rango de duración propio (en minutos simulados, 1 seg real = 10 min simulados).
 *
...
public class Tecnico {
    ...
    /**
     * Especialidades disponibles para los técnicos.
     * Cada especialidad define los tipos de servicio que puede atender
     * y el rango de duración estimada en minutos simulados.
     */
    public enum Especialidad {
        ...
        /** Duración mínima en minutos simulados para cualquier tarea de esta especialidad. */
        private final int duracionMinMin;

        /** Duración máxima en minutos simulados para cualquier tarea de esta especialidad. */
        ...
        public int getDuracionMinMin() { return duracionMinMin; }

        /** @return Duración máxima en minutos simulados. */
        public int getDuracionMaxMin() { return duracionMaxMin; }

        /**
         * Duración mínima en milisegundos reales (1 seg = 10 min simulados).
         * @return Milisegundos mínimos.
         */
        public long getDuracionMinMs() { return (duracionMinMin / 10L) * 1000L; }

        /**
         * Duración máxima en milisegundos reales (1 seg = 10 min simulados).
         * @return Milisegundos máximos.
         */
        public long getDuracionMaxMs() { return (duracionMaxMin / 10L) * 1000L; }
    ...
    /**
     * Tipos de servicio que el sistema puede solicitar.
     * Cada tipo está asociado a una especialidad requerida y aporta puntos de prioridad.
     */
    public enum TipoServicio {
        ...
        public Especialidad getEspecialidadRequerida() { return especialidadRequerida; }
