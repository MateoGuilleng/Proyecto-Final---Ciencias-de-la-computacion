...
/**
 * Representa una unidad de servicio de la empresa AutoRescate 24/7.
 * Cada unidad tiene un ID numérico simple, tipo, estado, zona y disponibilidad.
 * Una unidad en mantenimiento no puede ser asignada a ningún caso.
 *
...
public class UnidadServicio {
    ...
    public boolean isDisponible() { return this.estado == EstadoUnidad.DISPONIBLE; }
