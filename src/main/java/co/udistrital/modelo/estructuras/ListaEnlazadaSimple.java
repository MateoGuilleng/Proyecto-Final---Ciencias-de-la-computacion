 ...
 * Soporta inserción al final, eliminación por valor, consulta de tamaño e iteración.
 *
...
public class ListaEnlazadaSimple<T> {
     ...
     * Usa {@code equals()} para la comparación.
    ...
    public boolean eliminar(T dato) {
        ...
        while (actual.getSiguiente() != null) {
            if (actual.getSiguiente().getDato().equals(dato)) {
                if (actual.getSiguiente() == this.cola) this.cola = actual;
    ...
    public static class Iterador<I> {
         ...
         */
        public I siguiente() {
            if (!tieneSiguiente()) throw new NoSuchElementException("No hay más elementos.");
